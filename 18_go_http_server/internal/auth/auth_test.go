...
func TestGetBearerToken(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			headers: http.Header{
				"Authorization": []string{"Bearer some_token_value"},
			},
			want:    "some_token_value",
			wantErr: false,
		},
		{
		...
		},
		{
			...
			headers: http.Header{
				"Authorization": []string{"some_token_value"},
			},
			want:    "",
			wantErr: true,
		},
...
func TestGetAPIKey(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "valid API key",
			headers: http.Header{
				"Authorization": []string{"ApiKey some_api_key_value"},
			},
			want:    "some_api_key_value",
			wantErr: false,
		},
		{
			name:    "missing authorization header",
		...
		},
		{
			...
			headers: http.Header{
				"Authorization": []string{"some_api_key_value"},
			},
			want:    "",
			wantErr: true,
		},
