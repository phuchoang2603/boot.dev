...
-- return average age of users with following country_code
-- round to whole number, rename to average_age
SELECT users.country_code, ROUND(AVG(users.age)) AS average_age
FROM users
